...
/* Common methods */
static void *create_viterbi(uint16_t num_decoded_bits, uint16_t rate,
                            uint16_t order,
...
int chainback_viterbi27(void *vit, unsigned char *decoded,
                        uint16_t num_decoded_bits, uint16_t _) {
