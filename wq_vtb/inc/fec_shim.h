...
void *init_rs_char(int symbol_size, int primitive_polynomial, int first_consecutive_root,
                   int root_gap, int number_roots, uint16_t pad);
...
int chainback_viterbi27(void *vit, unsigned char *decoded, uint16_t n_decoded_bits, uint16_t _mystery);
...
int chainback_viterbi29(void *vit, unsigned char *decoded, uint16_t n_decoded_bits, uint16_t _mystery);
...
int chainback_viterbi39(void *vit, unsigned char *decoded, uint16_t n_decoded_bits, uint16_t _mystery);
...
int chainback_viterbi615(void *vit, unsigned char *decoded, uint16_t n_decoded_bits, uint16_t _mystery);
